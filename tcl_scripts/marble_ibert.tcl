...
puts "################################################################################"
puts "Begining QSFP loopback testing....."
puts "################################################################################"
...
if {$errors > 0} {
    puts "ERROR: On the following links: $error_links"; exit
} else {
    puts "PASS: All QSFP1 and QSFP2 links OK"
}

# remove links
remove_hw_sio_link [get_hw_sio_links {localhost:3121/*/IBERT/Quad_115/MGT_*/TX->localhost:3121/*/IBERT/Quad_115/MGT_*/RX}]
remove_hw_sio_link [get_hw_sio_links {localhost:3121/*/IBERT/Quad_116/MGT_*/TX->localhost:3121/*/IBERT/Quad_116/MGT_*/RX}]

# FMC testing
puts "################################################################################"
puts "Begining FMC loopback testing....."
puts "################################################################################"
puts "Sleep for 3 seconds...."
exec sleep 3
puts "################################################################################"
puts "Changing the GTX Quad 115 routing to have 2 channels on FMC P2 and 2 channels on FMC P1....."
puts "################################################################################"
exec python3 $MMC_PATH/scripts/load.py -d /dev/ttyUSB3 “r off”
...
if {$errors > 0} {
    ...
    puts "PASS: All FMC2 + FMC1 links OK"
}
...
exec sleep 10
puts "################################################################################"
puts "Changing the GTX Quad 115 routing to have 4 channels on FMC P2....."
puts "################################################################################"
