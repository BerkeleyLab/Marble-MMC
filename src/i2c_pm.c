...
// Data from python hex2c.py < MarbleMini.hex
// Stupidly based on xrp_program_static()
static int xrp_write_flash_static(uint8_t dev)
{
   uint8_t *dd[] = {
      "\x10\x00\x00\x00\xFF\xC5\x00\x0A\x03\x41\x00\xFA\x02\xDA\x20\x27\xE1\x28\x33\x0D\x78",
      "\x10\x00\x10\x00\x00\x00\x03\x00\x56\x00\x12\x02\x69\x97\x4A\x26\x28\x3C\x20\x01\x7E",
      "\x10\x00\x20\x00\x01\x01\x01\x01\x01\x1E\x1E\xCE\x04\xB0\x0D\x00\x40\x00\x40\xCB\xB5",
      "\x10\x00\x30\x00\x00\x12\x6C\x1E\x1E\x0C\x2E\x69\x98\x0A\x4D\x20\x00\x00\x08\xC4\x88",
      "\x10\x00\x40\x00\xFF\xC5\x00\x0A\x03\x41\x00\xFA\x02\xDA\x20\x13\xE1\x14\x33\x0D\x60",
      "\x10\x00\x50\x00\x00\x00\x03\x00\x50\x00\x11\x02\x65\x9B\x4E\x24\x26\x3C\x14\x08\x4A",
      "\x10\x00\x60\x00\x08\x08\x08\x08\x08\x1D\x1E\xCE\x04\xB0\x0D\x00\x40\x00\x40\xCB\x53",
      "\x10\x00\x70\x00\x00\x3E\x64\x7B\x7B\x1D\xF2\x48\x05\x1A\x26\x20\x00\x11\x18\x02\x01",
      "\x10\x00\x80\x00\xFF\xC5\x00\x0A\x03\x41\x00\xFA\x02\xDA\x20\x09\xE1\x14\x33\x0D\x2A",
      "\x10\x00\x90\x00\x00\x00\x04\x00\x6A\x00\x16\x02\x45\xBB\x5F\x2D\x31\x3C\x1A\x02\xC5",
      "\x10\x00\xA0\x00\x02\x02\x02\x02\x02\x1C\x1E\xCE\x04\xB0\x0D\x00\x40\x00\x40\xCB\x32",
      "\x10\x00\xB0\x00\x00\x35\x42\x7B\x7B\x16\x48\x57\xE5\x12\x07\x20\x00\x21\x18\x07\xC0",
      "\x10\x00\xC0\x00\xFF\xC5\x00\x0A\x03\x41\x00\xFA\x02\xDA\x20\x27\xE1\x28\x33\x0D\xB8",
      "\x10\x00\xD0\x00\x00\x00\x03\x00\x40\x00\x0D\x02\x51\xAF\x58\x3F\x45\x3C\x10\x40\x66",
      "\x10\x00\xE0\x00\x40\x40\x40\x40\x40\x1E\x1E\xCE\x04\xB0\x0D\x00\x40\x00\x40\xCB\xBA",
      "\x10\x00\xF0\x00\x00\x43\x50\x1E\x1E\x19\x5C\x4F\x6F\x17\x40\x29\x77\x01\x18\xFC\xF2",
      "\x10\x01\x00\x00\x05\x0F\xFF\x4C\x4F\x4C\x1E\x1C\x00\x30\x01\x9F\x55\x04\x04\x00\x8E",
      "\x10\x01\x10\x00\x10\x16\x04\x0A\x10\x00\x00\x00\x00\x20\x0F\x17\x10\x17\x0F\x6C\xB3",
      "\x10\x01\x20\x00\x64\x42\x50\x30\x18\x0C\x30\x00\x00\x00\x00\x00\x00\x00\x00\xFF\x56",
      "\x10\x01\x30\x00\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\x0F\x00\x00\x00\x71\x4A",
      "\x10\x01\x40\x00\x00\x00\x00\x02\x00\x00\x37\x00\x00\x0F\x04\x02\x06\x02\x0A\x09\x46",
      "\x10\x01\x50\x00\x0B\x09\x00\x00\x00\x00\x0F\x00\x02\x00\x00\x00\x00\x01\x00\x00\x79",
      "\x10\x01\x60\x00\x00\x00\x00\x04\x04\x00\x00\x00\x61\x62\x61\x61\x61\x00\x00\x62\x3F",
      "\x10\x01\x70\x00\x01\x62\xFA\x00\x80\x00\x00\xFF\x12\x02\xE2\x00\x1D\x00\x00\xF3\x9D",
      "\x10\x01\x80\x00\x00\x02\x50\x00\x00\xFF\xFF\xFA\x06\xFA\x04\xFA\x02\x96\x01\x00\x8E",
      "\x10\x01\x90\x00\x00\x00\x00\x00\x00\x00\x02\x00\x04\x00\x07\x00\x00\x00\x00\x64\xEE",
      "\x10\x01\xA0\x00\x21\x64\x64\x64\x21\x64\x64\x64\x21\x64\x64\x64\x21\x64\x64\x0A\x75",
      "\x10\x01\xB0\x00\x20\x0A\x05\x19\x00\xFF\x00\x00\x00\xFF\xFF\x00\x04\xFF\xFF\xCF\x29",
      "\x00\x00\x00\x01\xFF"
   };
   ...
   return rc&1;  // Convert 2 (End of file detected) into 0
}
...
void xrp_flash(uint8_t dev)
{
   ...
   if (rc != HAL_OK) return;
   if (xrp_write_flash_static(dev)) return;
