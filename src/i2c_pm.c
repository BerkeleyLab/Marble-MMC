...
static int xrp_program_page(uint8_t dev, unsigned page_no, const uint8_t data[], unsigned len)
{
...
#elif MARBLE_V2
   // Data from python hex2c.py < Marble.hex
   // Pure copy of 7 x 64-byte pages, spannning addresses 0x0000 to 0x01bf
   // (this version modded to use Marble_flash_6V-12V.hex)
   const uint8_t dd[] = {
      "\xFF\xC5\x00\x0A\x03\x41\x00\xFA\x02\xDA\x20\x13\xE1\x14\x33\x0D"
      "\x00\x00\x08\x00\xC0\x00\x28\x02\x15\xEB\x4E\x39\x3E\x19\x14\x01"
      "\x01\x01\x01\x01\x01\x1E\x1E\xCE\x04\xB0\x0D\x00\x40\x00\x40\xCB"
      "\x01\x4F\x64\x3D\x3D\x15\x42\x57\xD6\x12\xF7\x21\x7F\x12\x28\xF8"
      "\xFF\xC5\x00\x09\x03\x41\x00\xFA\x02\xDA\x20\x1D\xE1\x29\x67\x1A"
      "\x00\x00\x15\x02\x08\x00\x6C\x02\x09\x07\x42\x3F\x46\x19\x1A\x00"
      "\x40\x00\x40\x44\x44\x1C\x1E\x9E\x44\xB0\x0D\x00\x40\x00\x40\xFF"
      "\x01\xA3\x42\x3D\x3D\x1D\xA8\x4B\x71\x17\x40\x24\x7C\xA9\x18\x77"
      "\xFF\xC5\x00\x0A\x03\x41\x00\xFA\x02\xDA\x20\x27\xE1\x14\x33\x0D"
      "\x00\x00\x03\x00\x4D\x00\x10\x02\x11\xEF\x58\x4E\x56\x19\x10\x10"
      "\x10\x10\x10\x10\x10\x1E\x1E\xCE\x04\xB0\x0D\x00\x40\x00\x40\xCB"
      "\x00\xBA\x50\x1E\x1E\x18\xB1\x50\xB4\x16\xA6\x2A\x76\x01\x18\x55"
      "\xFF\xC5\x00\x0A\x03\x41\x00\xFA\x02\xDA\x20\x13\xE1\x14\x33\x0D"
      "\x00\x00\x05\x00\x8A\x00\x1D\x02\x91\x6F\x5C\x30\x33\x19\x0E\x20"
      "\x20\x20\x20\x20\x20\x1E\x1E\xCE\x04\xB0\x0D\x00\x40\x00\x40\xCB"
      "\x00\x83\x48\x3D\x3D\x15\x89\x58\x38\x12\x5D\x20\x00\x11\x18\x4E"
      "\x05\x00\x00\x4C\x4F\x4C\x18\x17\x00\x30\x01\x9F\x51\x02\x02\x00"
      "\x04\x16\x04\x0A\x10\x00\x00\x00\x00\x08\x0F\x17\x10\x17\x0F\x64"
      "\x42\x50\x48\x18\x0C\x30\x18\x00\x00\x00\x00\x00\x00\x00\x00\xFF"
      "\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\x0F\x00\x00\x00\xB7"
      "\x00\x02\x00\x02\x01\x00\x2E\x00\x00\x0F\x02\x05\x02\x03\x09\x0B"
      "\x09\x09\x00\x00\x00\x00\x0F\x00\x02\x00\x00\x00\x02\x01\x01\x00"
      "\x00\x00\x00\x04\x04\x00\x00\x00\x60\x42\x61\x61\x61\x00\x02\x62"
      "\x01\x62\xFA\x00\x80\x00\x00\xFF\x12\x02\xE3\x00\x1C\x00\x00\x46"
      "\x00\x02\x50\x00\x00\xFF\xFF\x32\x06\x32\x04\x32\x00\x00\x03\x00"
      "\x00\x00\x00\x00\x00\x00\x02\x00\x04\x00\x07\x00\x00\x00\x00\x64"
      "\x21\x64\x64\x64\x20\x64\x64\x64\x21\x64\x64\x64\x23\x64\x64\x0A"
      "\x20\x0A\x05\x19\xFF\xFF\x00\x00\x00\xFF\xFF\x00\x04\xFF\xFF\x08"
   };
#endif
